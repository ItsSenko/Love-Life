...
public class SceneScript : MonoBehaviour
{
    ...
    //Rect animSpeedGuiBodyRect = new Rect(770,520,170,150);
    //Rect positionYGuiBodyRect = new Rect(770,520,170,150);
    ...
    //string resourcesPath = "Arum";

    public string facialMatName = "f02_face_00";

    private bool guiShowFlg = false;
    private const string viewerResourcesPath = "Aoi";
    ...
    private string[] modeTextList = { "AddPerti cle", "Original" };
